        ...
        <div class="row">
            <div class="col-xl-6 col-lg-5 col-md-12 col-custom">
                <div class="feature-content-wrapper">
                    ...
                    <p class="desc-content">Eating fruit provides health benefits — people who eat more fruits
                        and vegetables as part of an overall healthy diet are likely to have a reduced risk of
                        some chronic diseases. Fruits provide nutrients vital for health and maintenance of your
                        body.</p>
                    <p class="desc-content"> Fruits are sources of many essential nutrients that are
                        underconsumed, including potassium, dietary fiber, vitamin C, and folate (folic acid).
                    </p>
                    <p class="desc-content"> Most fruits are naturally low in fat, sodium, and calories. None
                        have cholesterol.</p>
                </div>
            </div>
            ...
            <div class="col-lg-5 m-auto text-center col-custom">
                <div class="section-content">
                    ...
                    <div class="desc-content">
                        <p>All best seller product are now available for you and your can buy this product from
                            here any time any where so sop now</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="single-product position-relative">
                            ...
                            <div class="product-content">
                                ...
                                <div class="product-title">
                                    <h4 class="title-2"> <a href="index.php?act=product-detail">Product dummy name</a>
                                    </h4>
                                </div>
                                <div class="price-box">
                    ...
                    <div class="single-item">
                        <div class="single-product position-relative">
                            ...
                            <div class="product-content">
                                ...
                                <div class="product-title">
                                    <h4 class="title-2"> <a href="index.php?act=product-detail">Product dummy title</a>
                                    </h4>
                                </div>
                                <div class="price-box">
                                    <span class="regular-price ">$80.00</span>
            ...
            <div class="col-lg-8 col-xl-5 offset-xl-6 offset-lg-3 col-custom">
                <div class="newsletter-content text-center d-flex flex-column align-items-center justify-content-center h-100">
                    <div class="section-content">
                        ...
                        <p class="desc-content">Subscribe our newsletter and all latest news of our <br>latest
                            product, promotion and offers</p>
                    </div>
            ...
            <div class="col-lg-12 col-custom">
                <div class="support-wrapper d-flex">
                    <div class="support-content">
                        ...
                        <p class="desc-content">Call our support 24/7 at 0345-651-932</p>
                    </div>
